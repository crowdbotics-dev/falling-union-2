"""
Django settings for falling_union_2 project.
...
ROOT_URLCONF = 'falling_union_2.urls'
...
WSGI_APPLICATION = 'falling_union_2.wsgi.application'
...
DEFAULT_FROM_EMAIL = env.str(
    "DEFAULT_FROM_EMAIL", "Falling Union Support <support@falling-union-2.botics.io>"
)
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "falling_union_2 API",
    "DESCRIPTION": "API documentation for falling_union_2 App",
    "VERSION": "v1",
}
